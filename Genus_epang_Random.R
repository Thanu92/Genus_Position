...
names(Ref_Tree_distinct)
Ref_Tree_distinct_list <- as.list(Ref_Tree_distinct)
#To remove genus with single species
#First get the genus name list of co1 placements
names(R_co1_20_1)
...
R_co1_20_3_G<-as.data.frame(str_extract(R_co1_20_3$seq.name , "[^_]+"))
colnames(R_co1_20_3_G) <- "genus"
R_co1_20_3_G_vec <- as.vector(R_co1_20_3_G$genus)
R_co1_20_4_G<-as.data.frame(str_extract(R_co1_20_4$seq.name , "[^_]+"))
colnames(R_co1_20_4_G) <- "genus"
R_co1_20_4_G_vec <- as.vector(R_co1_20_4_G$genus)
R_co1_20_5_G<-as.data.frame(str_extract(R_co1_20_5$seq.name , "[^_]+"))
colnames(R_co1_20_5_G) <- "genus"
R_co1_20_5_G_vec <- as.vector(R_co1_20_5_G$genus)
R_co1_20_6_G<-as.data.frame(str_extract(R_co1_20_6$seq.name , "[^_]+"))
colnames(R_co1_20_6_G) <- "genus"
R_co1_20_6_G_vec <- as.vector(R_co1_20_6_G$genus)
R_co1_20_7_G<-as.data.frame(str_extract(R_co1_20_7$seq.name , "[^_]+"))
colnames(R_co1_20_7_G) <- "genus"
R_co1_20_7_G_vec <- as.vector(R_co1_20_7_G$genus)
R_co1_20_8_G<-as.data.frame(str_extract(R_co1_20_8$seq.name , "[^_]+"))
colnames(R_co1_20_8_G) <- "genus"
R_co1_20_8_G_vec <- as.vector(R_co1_20_8_G$genus)
R_co1_20_9_G<-as.data.frame(str_extract(R_co1_20_9$seq.name , "[^_]+"))
colnames(R_co1_20_9_G) <- "genus"
R_co1_20_9_G_vec <- as.vector(R_co1_20_9_G$genus)
R_co1_20_10_G<-as.data.frame(str_extract(R_co1_20_10$seq.name , "[^_]+"))
colnames(R_co1_20_10_G) <- "genus"
R_co1_20_10_G_vec <- as.vector(R_co1_20_10_G$genus)


R_co1_20_1_G_diff <- setdiff(R_co1_20_1_G,Ref_Tree_distinct)#222 genus with single species
R_co1_20_2_G_diff <- setdiff(R_co1_20_2_G,Ref_Tree_distinct)#229
R_co1_20_3_G_diff <- setdiff(R_co1_20_3_G,Ref_Tree_distinct)#218
R_co1_20_4_G_diff <- setdiff(R_co1_20_4_G,Ref_Tree_distinct)#225
R_co1_20_5_G_diff <- setdiff(R_co1_20_5_G,Ref_Tree_distinct)#224
R_co1_20_6_G_diff <- setdiff(R_co1_20_6_G,Ref_Tree_distinct)#228
R_co1_20_7_G_diff <- setdiff(R_co1_20_7_G,Ref_Tree_distinct)#221
R_co1_20_8_G_diff <- setdiff(R_co1_20_8_G,Ref_Tree_distinct)#207
R_co1_20_9_G_diff <- setdiff(R_co1_20_9_G,Ref_Tree_distinct)#221
R_co1_20_10_G_diff <- setdiff(R_co1_20_10_G,Ref_Tree_distinct)#215


class(R_co1_20_1_G_diff)
# R_co1_20_1_G_diff2 <- setdiff(Ref_Tree_distinct,R_co1_20_1_G)
# inter <- intersect(R_co1_20_1_G,Ref_Tree_distinct)
#Setfiff of Ref_Tree_distinct_list(which has two or more species in genus) and R_co1_20_1_G list will give the genus of single species
...
colnames(df_RefTree_R_co1_20_1_new) <- R_co1_20_1_G_vec
...
colnames(df_R_80_co1_20_1_new) <-R_co1_20_1_G_vec 
...
#To get genus with single species in dissimilar group,
#take intersect 
#Get the co1 placed genus names in dissimilar list#have to use t other wise different length lists can't be converted to a dataframe
df_dissimilar <- t(dissimilar)
df_dissimilar <- data.frame(df_dissimilar)
names_dissimilar <- data.frame(names(df_dissimilar))
colnames(names_dissimilar) <- "genus"
colnames(R_co1_20_1_G_diff) <- "genus"
intersect(names_dissimilar,R_co1_20_1_G_diff)#130
#number of genus with single species(monotypic) in R_co1_20_1 dissimilar group has 130
232-130 #102 polytypic genus in dissimilar group

df_similar <- t(similar)
df_similar <- data.frame(df_similar)
names_similar <- data.frame(names(df_similar))
colnames(names_similar) <- "genus"
colnames(R_co1_20_1_G_diff) <- "genus"
#R_co1_20_1_G_diff 222 genus with single species
intersect(names_similar,R_co1_20_1_G_diff)
#92 monotypic genus in similar group
#genus count without monotypic genes,
(672-92)/((672-92)+(232-130)) #0.85 means 85%
...
df_R_80_co1_20_2_List <- t(plyr::ldply(R_80_co1_20_2_List, rbind))#3849 rows
...
colnames(df_RefTree_R_co1_20_2_new) <- R_co1_20_2_G_vec
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_2_new <- data.frame(split(df_R_80_co1_20_2,rep(1:904,each=3849)))
class(df_R_80_co1_20_2_new)
colnames(df_R_80_co1_20_2_new) <-R_co1_20_2_G_vec 
...
similar <- uniq_RefTree_R_co1_20_2_new [(uniq_RefTree_R_co1_20_2_new %in% uniq_R_80_co1_20_2_new )] #667
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_2_new [!(uniq_RefTree_R_co1_20_2_new %in% uniq_R_80_co1_20_2_new )] #237
class(dissimilar)
...
names_dissimilar <- data.frame(names(df_dissimilar))
colnames(names_dissimilar) <- "genus"
colnames(R_co1_20_2_G_diff) <- "genus"
intersect(names_dissimilar,R_co1_20_2_G_diff)#142
#number of genus with single species(monotypic) in R_co1_20_1 dissimilar group has 130
237-142 #102 polytypic genus in dissimilar group
...
colnames(R_co1_20_2_G_diff) <- "genus"
#R_co1_20_1_G_diff 222 genus with single species
intersect(names_similar,R_co1_20_2_G_diff)#87
#92 monotypic genus in similar group
#genus count without monotypic genes,
(672-92)/((672-92)+(232-130)) #0.85 means 85%
(667-87)/((667-87)+(237-142)) #86%
#------------------------------------------------
#tibble(letters = a, count = unlist(map(a, function(x) sum(b %in% x))))
...
df_R_80_co1_20_3_List <- t(plyr::ldply(R_80_co1_20_3_List, rbind))#4491 rows
...
colnames(df_RefTree_R_co1_20_3_new) <- R_co1_20_3_G_vec
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_3_new <- data.frame(split(df_R_80_co1_20_3,rep(1:904,each=4491)))
class(df_R_80_co1_20_3_new)
colnames(df_R_80_co1_20_3_new) <-R_co1_20_3_G_vec 
...
similar <- uniq_RefTree_R_co1_20_3_new [(uniq_RefTree_R_co1_20_3_new %in% uniq_R_80_co1_20_3_new )] #658
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_3_new [!(uniq_RefTree_R_co1_20_3_new %in% uniq_R_80_co1_20_3_new )] #246
class(dissimilar)
...
names_dissimilar <- data.frame(names(df_dissimilar))
colnames(names_dissimilar) <- "genus"
colnames(R_co1_20_3_G_diff) <- "genus"
intersect(names_dissimilar,R_co1_20_3_G_diff)#124
#number of genus with single species(monotypic) in R_co1_20_1 dissimilar group has 130
246-124 #102 polytypic genus in dissimilar group
...
colnames(R_co1_20_3_G_diff) <- "genus"
#R_co1_20_1_G_diff 222 genus with single species
intersect(names_similar,R_co1_20_3_G_diff)#94
#92 monotypic genus in similar group
#genus count without monotypic genes,
(658-94)/((658-94)+(246-124)) #82
...
# class(similar)
# hh <- t(t(similar))
# df_similar <- plyr::ldply(similar, rbind)
# df_dissimilar <- plyr::ldply(dissimilar, rbind)
# class(df_similar)
# setdiff(Ref_Tree_distinct_list,similar)
# sapply(similar, `%in%`, x = Ref_Tree_distinct$genus)
# length(Ref_Tree_distinct_list)
# 
# 
# 
# df <- Ref_Tree_distinct[Ref_Tree_distinct$genus %in% df_similar$,]
# lis <- foreach(i=1:length(Ref_Tree_distinct_list)) %do% sapply(similar, `%in%`, x =c("Acanthurus","Blicca"))
# similar111 <- similar [(similar %in% Ref_Tree_distinct_list )] 
# class(similar)
# unlistsimilar <-as.list(data.frame(unlist(similar)))
# Filter(Negate(is.null), similar)
# Ref_Tree_distinct_vect <- as.vector(Ref_Tree_distinct)
# similar222 <- Ref_Tree_distinct_list [(Ref_Tree_distinct_list %in% similar )]
...
df_R_80_co1_20_4_List <- t(plyr::ldply(R_80_co1_20_4_List, rbind))#1544 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_4_new <- data.frame(split(df_R_80_co1_20_4,rep(1:904,each=1544)))
...
similar <- uniq_RefTree_R_co1_20_4_new [(uniq_RefTree_R_co1_20_4_new %in% uniq_R_80_co1_20_4_new )] #675
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_4_new [!(uniq_RefTree_R_co1_20_4_new %in% uniq_R_80_co1_20_4_new )] #229
...
df_R_80_co1_20_5_List <- t(plyr::ldply(R_80_co1_20_5_List, rbind))#4515 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_5_new <- data.frame(split(df_R_80_co1_20_5,rep(1:904,each=4515)))
...
similar <- uniq_RefTree_R_co1_20_5_new [(uniq_RefTree_R_co1_20_5_new %in% uniq_R_80_co1_20_5_new )] #652
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_5_new [!(uniq_RefTree_R_co1_20_5_new %in% uniq_R_80_co1_20_5_new )] #252
...
df_R_80_co1_20_6_List <- t(plyr::ldply(R_80_co1_20_6_List, rbind))#4086 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_6_new <- data.frame(split(df_R_80_co1_20_6,rep(1:904,each=4086)))
...
similar <- uniq_RefTree_R_co1_20_6_new [(uniq_RefTree_R_co1_20_6_new %in% uniq_R_80_co1_20_6_new )] #641
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_6_new [!(uniq_RefTree_R_co1_20_6_new %in% uniq_R_80_co1_20_6_new )] #263
...
df_R_80_co1_20_7_List <- t(plyr::ldply(R_80_co1_20_7_List, rbind))#1674 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_7_new <- data.frame(split(df_R_80_co1_20_7,rep(1:904,each=1674)))
...
similar <- uniq_RefTree_R_co1_20_7_new [(uniq_RefTree_R_co1_20_7_new %in% uniq_R_80_co1_20_7_new )] #657
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_7_new [!(uniq_RefTree_R_co1_20_7_new %in% uniq_R_80_co1_20_7_new )] #247
...
df_R_80_co1_20_8_List <- t(plyr::ldply(R_80_co1_20_8_List, rbind))#3115 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_8_new <- data.frame(split(df_R_80_co1_20_8,rep(1:904,each=3115)))
...
similar <- uniq_RefTree_R_co1_20_8_new [(uniq_RefTree_R_co1_20_8_new %in% uniq_R_80_co1_20_8_new )] #689
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_8_new [!(uniq_RefTree_R_co1_20_8_new %in% uniq_R_80_co1_20_8_new )] #215
...
df_R_80_co1_20_9_List <- t(plyr::ldply(R_80_co1_20_9_List, rbind))#4507 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_9_new <- data.frame(split(df_R_80_co1_20_9,rep(1:904,each=4507)))
...
similar <- uniq_RefTree_R_co1_20_9_new [(uniq_RefTree_R_co1_20_9_new %in% uniq_R_80_co1_20_9_new )] #651
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_9_new [!(uniq_RefTree_R_co1_20_9_new %in% uniq_R_80_co1_20_9_new )] #253
# #get the number of species have similar sisters by comparing with reference tree
...
df_R_80_co1_20_10_List <- t(plyr::ldply(R_80_co1_20_10_List, rbind))#4484 rows
...
#df_R_80_co1_20_1 has the same 904 genus names but each has 97 values (genus names)
df_R_80_co1_20_10_new <- data.frame(split(df_R_80_co1_20_10,rep(1:904,each=4484)))
...
similar <- uniq_RefTree_R_co1_20_10_new [(uniq_RefTree_R_co1_20_10_new %in% uniq_R_80_co1_20_10_new )] #639
#get the number of species doesn't have similar genus name comparing with reference tree
dissimilar <- uniq_RefTree_R_co1_20_10_new [!(uniq_RefTree_R_co1_20_10_new %in% uniq_R_80_co1_20_10_new )] #265
