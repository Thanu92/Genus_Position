...
RefTree_R_co1_20_1_List <- foreach(i=1:length(species_List[[19]])) %do% sister(ReferenceTree,species_List[[19]][i],type="terminal",label=T)
#Sister species for placement sequeneces(20%) after placing on bb tree(80% bb tree)
R_80_co1_20_1_List <- foreach(i=1:length(species_List[[19]])) %do% sister(treeList$EPA80_8R_new.nwk,species_List[[19]][i],type="terminal",label=T)
...
#Sister species for placement sequeneces(20%) after placing on bb tree(80% bb tree)
R_60_co1_40_1_List <- foreach(i=1:length(species_List[[29]])) %do% sister(treeList$EPA60_8R_new.nwk,species_List[[29]][i],type="terminal",label=T)
...
RefTree_R_co1_60_1_List <- foreach(i=1:length(species_List[[39]])) %do% sister(ReferenceTree,species_List[[39]][i],type="terminal",label=T)
#Sister species for placement sequeneces(20%) after placing on bb tree(80% bb tree)
R_40_co1_60_1_List <- foreach(i=1:length(species_List[[39]])) %do% sister(treeList$EPA40_8R_new.nwk,species_List[[39]][i],type="terminal",label=T)
...
RefTree_R_co1_80_1_List <- foreach(i=1:length(species_List[[49]])) %do% sister(ReferenceTree,species_List[[49]][i],type="terminal",label=T)
#Sister species for placement sequeneces(20%) after placing on bb tree(80% bb tree)
R_20_co1_80_1_List <- foreach(i=1:length(species_List[[49]])) %do% sister(treeList$EPA20_8R_new.nwk,species_List[[49]][i],type="terminal",label=T)
...
RefTree_R_co1_1_1_List <- foreach(i=1:length(species_List[[9]])) %do% sister(ReferenceTree,species_List[[9]][i],type="terminal",label=T)
#Sister species for placement sequeneces(20%) after placing on bb tree(80% bb tree)
R_99_co1_1_1_List <- foreach(i=1:length(species_List[[9]])) %do% sister(treeList$EPA99_8R_new.nwk,species_List[[9]][i],type="terminal",label=T)
...
monotypic_genus_result <- genus_count(RefTree_R_co1_1_1_List,R_99_co1_1_1_List,9)
